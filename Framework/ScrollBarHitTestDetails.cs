//---------------------------------------------------------------------
// <copyright file="ScrollBarHitTestDetails.cs" company="Microsoft">
...
{
    /// <summary>
    /// Provides more details about the contact hit on the scroll bar, including 
    ...
    public class ScrollBarHitTestDetails : IHitTestDetails
    {
        ...
        /// </summary>
        /// <param name="position">The point where a contact hit the scroll bar. Valid values
        ...
        /// <summary>
        /// Gets or sets the position value where a contact hit 
        /// the scroll bar.  
        /// </summary>
        ...
        /// <returns>The point where a contact hit the scroll bar.</returns>
