//---------------------------------------------------------------------
// <copyright file="ScrollViewerHitTestDetails.cs" company="Microsoft">
...
{
    /// <summary>
    /// Provides more details about the contact hit on the <strong>ScrollViewer</strong> object, including 
    ...
    public class ScrollViewerHitTestDetails : IHitTestDetails
    {
        ...
        /// where a contact hit the scroll bar from 0 to 1. A value of 0 indicates a 
        ...
        /// contact hit the scroll bar from 0 to 1. A value of 0 indicates a 
        ...
        /// <summary>
        /// Gets or sets the horizontal normalized coordinate where a contact hit 
        /// the scroll bar. 
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the vertical normalized coordinate where a contact hit 
        /// the scroll bar. 
        /// </summary>
