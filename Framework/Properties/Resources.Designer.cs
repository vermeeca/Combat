...
namespace CoreInteractionFramework.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The Contact with and id of {0} couldn&apos;t be released because it isn&apos;t captured..
        /// </summary>
        internal static string CantReleaseNonCapturedContactException {
            get {
                return ResourceManager.GetString("CantReleaseNonCapturedContactException", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The Contact with an Id of {0} is already captured by the UIController..
        /// </summary>
        internal static string ContactAlreadyCapturedException {
            get {
                return ResourceManager.GetString("ContactAlreadyCapturedException", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The Contact {0} is already in the collection {1}.
        /// </summary>
        internal static string ContactIsAlreadyInCollectionException {
            get {
                return ResourceManager.GetString("ContactIsAlreadyInCollectionException", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The Contact {0} is not in the collection {1}.
        /// </summary>
        internal static string ContactIsNotInCollectionException {
            get {
                return ResourceManager.GetString("ContactIsNotInCollectionException", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The maximum size for the controller queue {0} contact events was reached..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The StateMachine provided was of type {0}, but must be of type {0}.  This could be because the contact is already captured to type {1}..
        /// </summary>
