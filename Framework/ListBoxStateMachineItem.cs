//---------------------------------------------------------------------
// <copyright file="ListBoxStateMachineItem.cs" company="Microsoft">
...
namespace CoreInteractionFramework
{
    ...
    public class ListBoxStateMachineItem
    {
        ...
        internal List<int> capturedContacts = new List<int>();
        ...
        /// <summary>
        /// Handles ContactDown events.
        /// </summary>
        internal void ProcessContactDown(int id)
        {
            capturedContacts.Add(id);
        ...
        /// <summary>
        /// Handles ContactUp Events for contacts which are captured.
        /// </summary>
        internal void ProcessCapturedContactUp(int id)
        {
            capturedContacts.Remove(id);
            

            if (capturedContacts.Count == 0)
            {
                IsPressed = false;
